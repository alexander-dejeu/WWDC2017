...
class watchScene : UIView{

  
  override func draw(_ rect: CGRect){
    var watchView = customBackgroundView(frame: CGRect(x: 0, y: 0, width: 344.25, height: 633))
    ...
    let sunView = UIView(frame: CGRect(x: 0.225375626 * self.frame.width, y: 0.2317460317 * self.frame.height, width: 0.2846560847 * self.frame.height, height: 0.2846560847 * self.frame.height))
    //135 X
    // 219 Y
    // 269 H + W
