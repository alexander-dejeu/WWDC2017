...
public class Cloud : UIView {
  ...
  func drawLeftAirpodCloud(){
    ...
    //// Bezier Drawing
    let bezierPath = UIBezierPath()
    bezierPath.move(to: CGPoint(x: 29.51, y: 118.88))
    bezierPath.addLine(to: CGPoint(x: 209.51, y: 118.88))
    bezierPath.addCurve(to: CGPoint(x: 265.76, y: 57), controlPoint1: CGPoint(x: 240.57, y: 118.88), controlPoint2: CGPoint(x: 265.76, y: 91.18))
    bezierPath.addLine(to: CGPoint(x: 265.76, y: 57))
    bezierPath.addLine(to: CGPoint(x: 265.76, y: 57))
    bezierPath.addCurve(to: CGPoint(x: 241.79, y: 6.38), controlPoint1: CGPoint(x: 265.76, y: 36.05), controlPoint2: CGPoint(x: 256.28, y: 17.57))
    bezierPath.addLine(to: CGPoint(x: 177.23, y: 6.38))
    bezierPath.addCurve(to: CGPoint(x: 153.26, y: 57), controlPoint1: CGPoint(x: 162.74, y: 17.57), controlPoint2: CGPoint(x: 153.26, y: 36.05))
    bezierPath.addCurve(to: CGPoint(x: 159.45, y: 85.12), controlPoint1: CGPoint(x: 153.26, y: 67.14), controlPoint2: CGPoint(x: 155.52, y: 76.68))
    bezierPath.addLine(to: CGPoint(x: 29.51, y: 85.12))
    bezierPath.usesEvenOddFillRule = true
    fillColor.setFill()
    bezierPath.fill()
    ...
    //// Bezier 2 Drawing
    let bezier2Path = UIBezierPath()
    bezier2Path.move(to: CGPoint(x: 29.51, y: 118.88))
    bezier2Path.addLine(to: CGPoint(x: 209.51, y: 118.88))
    bezier2Path.addCurve(to: CGPoint(x: 265.76, y: 57), controlPoint1: CGPoint(x: 240.57, y: 118.88), controlPoint2: CGPoint(x: 265.76, y: 91.18))
    bezier2Path.addLine(to: CGPoint(x: 265.76, y: 57))
    bezier2Path.addLine(to: CGPoint(x: 265.76, y: 57))
    bezier2Path.addCurve(to: CGPoint(x: 241.79, y: 6.38), controlPoint1: CGPoint(x: 265.76, y: 36.05), controlPoint2: CGPoint(x: 256.28, y: 17.57))
    bezier2Path.addLine(to: CGPoint(x: 177.23, y: 6.38))
    bezier2Path.addCurve(to: CGPoint(x: 153.26, y: 57), controlPoint1: CGPoint(x: 162.74, y: 17.57), controlPoint2: CGPoint(x: 153.26, y: 36.05))
    bezier2Path.addCurve(to: CGPoint(x: 159.45, y: 85.12), controlPoint1: CGPoint(x: 153.26, y: 67.14), controlPoint2: CGPoint(x: 155.52, y: 76.68))
    bezier2Path.addLine(to: CGPoint(x: 29.51, y: 85.12))
    strokeColor.setStroke()
    bezier2Path.lineWidth = 11.25
    bezier2Path.lineCapStyle = .round
    bezier2Path.lineJoinStyle = .round
    ...
    //// Bezier 3 Drawing
    let bezier3Path = UIBezierPath()
    bezier3Path.move(to: CGPoint(x: 29.51, y: 118.88))
    bezier3Path.addLine(to: CGPoint(x: 18.26, y: 118.88))
    bezier3Path.addCurve(to: CGPoint(x: 7.01, y: 107.62), controlPoint1: CGPoint(x: 12.05, y: 118.88), controlPoint2: CGPoint(x: 7.01, y: 113.84))
    bezier3Path.addLine(to: CGPoint(x: 7.01, y: 96.38))
    bezier3Path.addLine(to: CGPoint(x: 7.01, y: 96.38))
    bezier3Path.addCurve(to: CGPoint(x: 18.26, y: 85.12), controlPoint1: CGPoint(x: 7.01, y: 90.16), controlPoint2: CGPoint(x: 12.05, y: 85.12))
    bezier3Path.addLine(to: CGPoint(x: 29.51, y: 85.12))
    bezier3Path.usesEvenOddFillRule = true
    fillColor.setFill()
    bezier3Path.fill()
    ...
    //// Bezier 4 Drawing
    let bezier4Path = UIBezierPath()
    bezier4Path.move(to: CGPoint(x: 29.51, y: 118.88))
    bezier4Path.addLine(to: CGPoint(x: 18.26, y: 118.88))
    bezier4Path.addCurve(to: CGPoint(x: 7.01, y: 107.62), controlPoint1: CGPoint(x: 12.05, y: 118.88), controlPoint2: CGPoint(x: 7.01, y: 113.84))
    bezier4Path.addLine(to: CGPoint(x: 7.01, y: 96.38))
    bezier4Path.addLine(to: CGPoint(x: 7.01, y: 96.38))
    bezier4Path.addCurve(to: CGPoint(x: 18.26, y: 85.12), controlPoint1: CGPoint(x: 7.01, y: 90.16), controlPoint2: CGPoint(x: 12.05, y: 85.12))
    bezier4Path.addLine(to: CGPoint(x: 29.51, y: 85.12))
    strokeColor.setStroke()
    bezier4Path.lineWidth = 11.25
    bezier4Path.lineCapStyle = .round
    bezier4Path.lineJoinStyle = .round
