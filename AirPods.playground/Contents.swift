...
let smallCloud1 : Cloud = Cloud(frame : CGRect(x: 48, y: 43, width: 167, height: 104))

let doubleCloud : Cloud = Cloud(frame : CGRect(x: 284, y: 44, width: 284, height: 140))
doubleCloud.cloudType = .partialLeftAndFullRightCloud

view.addSubview(smallCloud1)
